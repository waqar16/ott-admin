...
export const SubtitleUploader: React.FC<SubtitleUploaderProps> = ({ assetId }) => {
  ...
  const handleChange = (index: number, field: keyof SubtitleItem, value: any) => {
    setSubtitles((prev) =>
  ...
  React.useEffect(() => {
    ...
    subs().finally(() => setSubtitlesLoading(false))
  }, [])
  return (
            ...
            {subtitles.map((item, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  />
                  <label className="text-sm text-gray-300">Set as default subtitle</label>
                </div>
