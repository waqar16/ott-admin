...
export default function EpisodePlayerModal({ episode, onClose }: EpisodePlayerModalProps) {
                ...
                <div className="  flex flex-col items-start w-3/12 ml-4">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-gray-300">
                      ...
                      {Math.floor(episode.duration / 60)} mins {episode.duration % 60} secs
                    </p>
                    <p className="text-gray-300">
                      <span className="font-semibold">Media Type:</span> {episode.media_type}
                    </p>
                    <p className="text-gray-300">
                      <span className="font-semibold">Ingest Status:</span> {episode.ingest_status}
                    </p>
                  </div>
                </div>
              </div>
