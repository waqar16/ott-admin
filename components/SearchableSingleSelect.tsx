  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(async () => {
      try {
        ...
        const res = await axios.get(`${API_BASE}api/v1/content/search-movies`, {
          params: { q: search },
        })
      ...
      {open && (
        <div className="absolute z-30 w-full mt-2 bg-neutral-950 rounded-lg shadow-lg border border-gray-700">
          ...
          <div className="max-h-52 overflow-y-auto">
            {loading && <div className="px-4 py-3 text-gray-400 text-sm">Searching...</div>}
              ...
              options.map((opt) => {
                ...
                return (
                  <div
                    ...
                    className={`my-[2px] flex items-center px-4 py-2 cursor-pointer hover:bg-gray-700 ${
