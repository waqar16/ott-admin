...
export async function signup(userData: {
  ...
  try {
    ...
    throw new ApiError(0, error instanceof Error ? error.message : 'Network error during signup')
  }
}
...
export async function me(accessToken: string): Promise<User> {
  ...
  try {
    ...
    throw new ApiError(0, error instanceof Error ? error.message : 'Network error fetching profile')
  }
}
