    ...
    basePayload.detail.outputGroupDetails = [
      {
        outputDetails: [
          {
            outputFilePaths: [`s3://urview-processed/content/${contentId}/hls_720p/playlist.m3u8`],
            durationInMs: 120000,
            videoDetails: {
              widthInPx: 1280,
              heightInPx: 720,
          ...
          {
            outputFilePaths: [`s3://urview-processed/content/${contentId}/hls_1080p/playlist.m3u8`],
            durationInMs: 120000,
            videoDetails: {
              widthInPx: 1920,
              heightInPx: 1080,
