...
export default function AdminWatchPage() {
    ...
    return (
      ...
      >
        <div style={{ textAlign: 'center', color: '#fff' }}>
          <div style={{ fontSize: 20, fontWeight: 700, marginBottom: 8 }}>Unable to Play</div>
          <div style={{ opacity: 0.8, marginBottom: 18 }}>{error}</div>
  ...
  return (
    <div className="watch-page-netflix">
      ...
      {/* Back Button */}
      <button className="watch-back-btn" onClick={() => router.back()} aria-label="Back">
        <ArrowLeft size={28} />
      </button>
      ...
      <div className="watch-player-absolute">
        {isVR ? (
          ...
          <ShakaPlayer src={playbackUrl} drmToken={drmToken} autoPlay t={t} watermarkText="" />
        )}
      </div>
    </div>
  )
