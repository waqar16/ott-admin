...
const UserProfilesPage = () => {
  ...
  return (
    <div className="p-6 bg-gray-900">
      ...
      {/* Table */}
      <div className="bg-gray-800 p-4 rounded-lg shadow border border-gray-700 overflow-x-auto">
              ...
              [...Array(5)].map((_, i) => (
                <tr key={i}>
                  <td colSpan={6} className="p-3">
                    <SkeletonLoader className="h-6 w-full bg-gray-700" />
                  </td>
                </tr>
              ))
            ) : profiles.length === 0 ? (
      ...
      <div className="flex justify-center items-center gap-4 mt-8">
        <button
          ...
          className={`px-4 py-2 rounded-lg ${
            page === 1 ? "bg-gray-700" : "bg-gray-600 hover:bg-gray-700"
          } text-white`}
        >
          Previous
        </button>
        ...
        <button
          ...
          onClick={() => setPage((p) => p + 1)}
          className={`px-4 py-2 rounded-lg ${
            page * 10 >= count ? "bg-gray-700" : "bg-gray-600 hover:bg-gray-700"
          } text-white`}
        >
          Next
        </button>
