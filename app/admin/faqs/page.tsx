...
const [showCreate, setShowCreate] = useState(false);
  ...
  return (
    <div className="mt-16 md:mt-0 p-2 md:p-6 text-white space-y-6 bg-black">
      {/* Header */}
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">FAQs Management</h1>
          <p className="text-neutral-400">Manage platform frequently asked questions</p>
        </div>
...
<div className="flex gap-3">
  <button
    ...
    className="px-4 py-2 bg-[var(--main-color)] rounded"
  >
    + Add FAQ
  </button>
