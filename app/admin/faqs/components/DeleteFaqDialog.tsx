...
interface DeleteFaqDialogProps {
  faq: FAQ | null
  onClose: () => void
  onConfirm: (faq: FAQ) => Promise<void>
}
      ...
      <div className="bg-card border border-border/80 rounded-2xl p-6 w-full max-w-md shadow-2xl space-y-5 relative">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-1">
            <h3 className="text-lg font-bold tracking-tight text-foreground">Delete FAQ</h3>
            <p className="text-xs text-muted-foreground leading-relaxed">
              Are you sure you want to delete{' '}
              <strong className="text-foreground font-semibold px-1 py-0.5 rounded bg-accent line-clamp-2">
                "{faq.question}"
              </strong>
